...
import { generateProgressPercentage } from "../libs/generate-progress-percentage";
...
export function HabitDay({amountOfHabits = 0, amountCompleted = 0, date,...rest}: Props) {
    const amountAccomplishedPercentage = amountCompleted > 0 ? 
    ...
    return (
        <TouchableOpacity 
            className={clsx('rounded-lg border-2 m-1', {
                ...
                ['bg-violet-400 border-violet-300']: amountAccomplishedPercentage === 100,
